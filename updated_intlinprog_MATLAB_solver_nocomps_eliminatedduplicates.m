...
datanodes=load('DLandComp_nodes_without_Duplicates.mat');
datanodes=datanodes.DLandComp_nodes_without_Duplicates;
datanodes=datanodes(1:134);
...
%x4=intlinprog(f,intcon,A,b,Aeq,beq,lb,ub,x,options);

%%
segments = find(x4(1:nCombs)<1.05 & x4(1:nCombs)>.95); % Get indices of lines on optimal path
